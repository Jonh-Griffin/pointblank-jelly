...
public class AmmoOverrideFeature extends ConditionalFeature {
    ...
    public AmmoOverrideFeature(FeatureProvider owner, Predicate<ConditionContext> condition, String ammoId, boolean overrideOnly) {
    ...
    public Item getOverrideAmmo() {
        if (cachedItem == null) {
            ...
            if (supplier == null || supplier.get() == null) {
                throw new IllegalStateException("AmmoOverrideFeature: Unable to resolve ammo '" + ammoId + "' at runtime");
            }
