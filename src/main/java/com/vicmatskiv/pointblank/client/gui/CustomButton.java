...
public class CustomButton extends AbstractButton {
   ...
   protected void renderWidget(GuiGraphics guiGraphics, int mouseX, int mouseY, float partialTick) {
      ...
      guiGraphics.blitNineSliced(BUTTON_RESOURCE, this.getX(), this.getY(), this.getWidth(), this.getHeight(), 20, 4, textureWidth, textureHeight, 0, vOffset);
      ...
      renderScrollingString(guiGraphics, minecraft.font, this.getMessage(), this.getX() + 8, this.getY(), this.getX() + this.getWidth() - 8, this.getY() + this.getHeight(), i | Mth.ceil(this.alpha * 255.0F) << 24);
   }
