...
public class VertexConsumers {
   ...
   private static class ColorTexLightmapWrapper extends VertexConsumerWrapper {
      ...
      public void endVertex() {
         this.vertexConsumer.vertex(this.transform, (float)this.x, (float)this.y, (float)this.z).color(this.r, this.g, this.b, this.a).uv(this.u, this.v).overlayCoords(0).uv2(this.uv1, this.uv2).normal(0.0F, 0.0F, 1.0F).endVertex();
      }
   }
}
