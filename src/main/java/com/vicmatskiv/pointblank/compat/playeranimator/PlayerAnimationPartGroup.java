...
public enum PlayerAnimationPartGroup {
    ...
    private static Optional<AdjustmentModifier.PartModifier> correctRotation(Player player, String partName) {
        ...
        if (player == mainPlayer &&
            ...
            mc.screen == null &&
            mainPlayer.getMainHandItem().getItem() instanceof GunItem &&
            ROTATED_PARTS.contains(partName)) {
            ...
            float yawDelta = Mth.rotLerp(partialTicks, player.yHeadRotO - player.yBodyRotO, player.yHeadRot - player.yBodyRot);
