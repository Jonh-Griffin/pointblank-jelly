...
public class MiscItem extends Item implements Nameable, Tradeable, Craftable {
   ...
   public static class MiscItemBuilder extends ItemBuilder<MiscItemBuilder> implements Nameable {
      ...
      public Item build() {
         return this.rendererBuilder != null ? new MiscModelItem(this.name, this.rendererBuilder, this.tradePrice, this.tradeBundleQuantity, this.tradeLevel, this.craftingDuration) : new MiscItem(this.name, this.tradePrice, this.tradeBundleQuantity, this.tradeLevel, this.craftingDuration);
      }
   }
