...
public class PointBlankRecipeBuilder implements RecipeBuilder {
   ...
   public void save(Consumer<FinishedRecipe> consumer, ResourceLocation recipeId) {
      ...
      consumer.accept(new Result(this.serializer, recipeId, this.result, this.count, this.group == null ? "" : this.group, this.ingredients, this.advancement, recipeId.withPrefix("recipes/" + this.category.getFolderName() + "/")));
   }
   ...
   public static class Result implements FinishedRecipe {
      ...
      public Result(RecipeSerializer<?> serializer, ResourceLocation recipeId, Item resultItem, int count, String group, List<PointBlankIngredient> ingredients, Advancement.Builder advancementBuilder, ResourceLocation advancementId) {
         this.serializer = serializer;
         this.id = recipeId;
