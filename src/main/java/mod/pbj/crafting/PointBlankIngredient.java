...
public interface PointBlankIngredient {
   ...
   default boolean matches(ItemStack itemStack) {
      return itemStack != null && this.getItemStacks().stream().anyMatch((ingredientStack) -> ingredientStack.is(itemStack.getItem()));
   }
   ...
   static PointBlankIngredient fromNetwork(FriendlyByteBuf byteBuf) {
      ...
      return isItem ? PointBlankIngredient.ItemIngredient.fromNetwork(byteBuf) : PointBlankIngredient.TagIngredient.fromNetwork(byteBuf);
   }
