...
public interface GunStateListener extends RenderListener {
	...
	default void
	onAttachmentAdded(LivingEntity player, GunClientState state, ItemStack itemStack, ItemStack attachmentStack) {}
	...
	default void onHitScanTargetAcquired(
		LivingEntity player, GunClientState gunClientState, ItemStack itemStack, HitResult hitResult) {}

	default void onHitScanTargetConfirmed(
		LivingEntity player, GunClientState gunClientState, ItemStack itemStack, HitResult hitResult, float damage) {}
