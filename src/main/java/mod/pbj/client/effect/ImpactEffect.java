            ...
            if (!(progress < 0.0F)) {
               ...
               if (uv != null) {
                  ...
                  for(int k = 0; k < this.brightness; ++k) {
                     vertexConsumer.vertex(avector3f[0].x(), avector3f[0].y(), avector3f[0].z()).uv(u1, v1).color(argbColor).uv2(lightColor).endVertex();
                     vertexConsumer.vertex(avector3f[1].x(), avector3f[1].y(), avector3f[1].z()).uv(u1, v0).color(argbColor).uv2(lightColor).endVertex();
                     vertexConsumer.vertex(avector3f[2].x(), avector3f[2].y(), avector3f[2].z()).uv(u0, v0).color(argbColor).uv2(lightColor).endVertex();
                     vertexConsumer.vertex(avector3f[3].x(), avector3f[3].y(), avector3f[3].z()).uv(u0, v1).color(argbColor).uv2(lightColor).endVertex();
                  }
