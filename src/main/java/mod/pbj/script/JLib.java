...
public final class JLib {
	...
	public static <E extends Event> void ForgeEvent(String className, Consumer<E> eventConsumer)
		throws ClassNotFoundException {
		if (eventConsumer == null) {
			throw Context.reportRuntimeError("PBJImporter: registerEvent requires a non-null event consumer");
		}
		MinecraftForge.EVENT_BUS.addListener(
			EventPriority.NORMAL, false, (Class<E>)Class.forName(className), eventConsumer);
	}
