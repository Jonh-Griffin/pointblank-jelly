      ...
      if (effectOwnerEntity instanceof Player effectOwnerPlayer) {
         ...
         if (effectBuilderSupplier != null) {
            ...
            if (packet.hasMuzzlePositionProvider && gunState != null) {
               positionProvider = () -> GunStatePoseProvider.getInstance().getPositionAndDirection(gunState, PoseContext.THIRD_PERSON_MUZZLE);
               poseProvider = () -> GunStatePoseProvider.getInstance().getPose(gunState, PoseContext.THIRD_PERSON_MUZZLE);
            }
