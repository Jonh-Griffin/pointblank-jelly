...
public class BulletModifierFeature extends ConditionalFeature {
    ...
    public BulletModifierFeature(FeatureProvider owner, Predicate<ConditionContext> predicate, float velocity, float gravity, float inaccuracy, float speedOffset, float maxSpeedOffset, Script script) {
    ...
    public static class Builder implements FeatureBuilder<Builder, BulletModifierFeature> {
        ...
        public BulletModifierFeature build(FeatureProvider owner) {
            return new BulletModifierFeature(owner, predicate, velocity, gravity, inaccuracy, speedOffset, maxSpeedOffset, script);
        }
    }
}